...
function Navbar() {
  ...
  return (
    ...
    >
        ...
        <a href="#/">
          <img
            className={`cursor-pointer ${
              !navScroll
                ? "w-[220px] sm:w-[150px] xl:w-[220px] sm:ml-[20px] lg:ml-[50px] xl:ml-[100px]"
                : "w-[80px] my-[-20px] mb-[-30px]"
            }`}
            src={logo}
            alt="Culrav Logo"
          />
      ...
      >
        <ul
          className={`flex flex-row items-center justify-center md:ml-[10px] xl:ml-[20px] 2xl:ml-[50px] text-xs text-black ${
        ...
        >
          ...
          >
            <li
              className="text-sm cursor-pointer font-Mont lg:text-[14px] 2xl:text-[15px]"
        ...
        {toggle && (
          <div>
            ...
            >
              ...
              <div className="logo mt-[-30px] mb-[-10px] z-0 flex justify-center items-center">
