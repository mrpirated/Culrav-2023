...
function DashboardNavbar(props) {
	const { setOption, navItems } = props;
			...
			<div className='bg-off w-full h-[60px] shadow-md flex flex-row z-50 '>
				...
				{toggle && (
					<div>
						<motion.div
							id='NavBlur'
							className='fixed top-0 left-0 right-0 z-50 flex flex-col items-end justify-end w-screen p-1 pb-4 shadow-lg lg:hidden bg-warm'
							animate={{ y: [-500, 0] }}
							transition={{
								type: "spring",
								bounce: 0.25,
